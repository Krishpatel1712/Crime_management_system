<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      if($count == 1) {
         ...
         // Check officer table as well for profile display
         $sql2 = "SELECT * FROM officer WHERE offName = '$myusername' and offID = '$mypassword'";
...
<head>
    ...
    <title>Criminal Management | Login</title>
...
<body>
    <div id="box1">
        ...
        <h2 style="color: #1a237e;">Admin Login</h2>
        <p style="color: #666; font-size: 14px;">Criminal Management System</p>
        ...
        <form method="post" style="width: 100%;">
            ...
            <button class="btn">Login to System</button>
        </form>
